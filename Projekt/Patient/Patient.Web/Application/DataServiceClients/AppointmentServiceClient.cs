namespace Patient.Web.Application.DataServiceClients
{
    ...
    public class AppointmentServiceClient : IAppointmentServiceClient
    {
        ...
        {
            string url = Environment.GetEnvironmentVariable("medAppoint");

            var request = new HttpRequestMessage(HttpMethod.Get,
            url+$"/GetClosestPatientAppointments?idPatient={idPatient}");
        ...
        public async Task<IEnumerable<AppointmentDto>> GetAllPatientAppointmentsAsync(int idPatient)
        {
            ...
            var request = new HttpRequestMessage(HttpMethod.Get,
            url+$"/GetAllPatientAppointments?idPatient={idPatient}");
            request.Headers.Add("Accept", "application/json");
        ...
        public async Task DeleteAppointmentAsync(int Id)
        {
            ...
            url+$"/DeleteAppointment?IdAppointment={Id}");
            request.Headers.Add("Accept", "application/json");
